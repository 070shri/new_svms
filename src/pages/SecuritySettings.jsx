          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 mb-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-gray-900">{user?.name || 'Michael Chen'}</h2>
                  <div className="flex items-center gap-1 text-sm text-green-600 mt-1">
                    <span className="px-2 py-0.5 bg-green-100 rounded">Security</span>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 mt-6 pt-6 border-t border-gray-200">
              <div className="flex items-center gap-2 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900">{user?.email || 'michael.chen@company.com'}</p>
                </div>
              </div>
              <div className="flex items-center gap-2 text-sm">
